...
| `supertone_api` + `supertoneApi.language` ∈ PromptLanguage(ko/en/ja/es/pt/fr) | `supertoneApi.language` | `supertoneApi.language` |
| `supertone_api` + `supertoneApi.language` ∉ PromptLanguage (zh 등) | `en` | `supertoneApi.language` (예: zh) |
