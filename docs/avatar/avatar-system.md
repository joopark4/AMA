...
| `AnimationManager.tsx` | 표정/물리/댄스/IdleFidget 레이어 오케스트레이션 |
...
| Layer 0.5 | IdleFidgetController | 호흡 + 시선 미세 이동 |
| Layer 1 | PhysicsController | SpringBone (머리카락/옷) |
| Layer 2 | ExpressionController + EyeController + LookAtController | 표정/눈 깜빡임/시선 |
| Layer 3 | DanceController | 리듬 기반 댄스 |
| Layer 4 | HumanoidSyncController | VRM 호환 최종 동기화 |
